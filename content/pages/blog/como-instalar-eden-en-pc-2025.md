...
- Ve a **Herramientas > Instalar claves** y selecciona el archivo `prod.keys`.
- Puedes conseguir estas claves desde el Discord del creador o su sitio web.

### b) Firmware de la consola

- Descarga la versión recomendada: **19.0.0 o 20.0.0**.
