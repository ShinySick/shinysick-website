  ...
  - type: FeaturedItemsSection
    ...
    actions:
      ...
      - type: Button
        ...
        iconPosition: right
        style: primary
        altText: Dale clic para una sorpresa
      - type: Button
        label: Firmware
